...
if {$pdk_name eq "asap7"} {
	...
	# Liberty units are fF,kOhm
	set_layer_rc view -layer M1 -capacitance 1.1368e-01 -resistance 1.3889e-01
	set_layer_rc view -layer M2 -capacitance 1.3426e-01 -resistance 2.4222e-02
	set_layer_rc view -layer M3 -capacitance 1.2918e-01 -resistance 2.4222e-02
	set_layer_rc view -layer M4 -capacitance 1.1396e-01 -resistance 1.6778e-02
	set_layer_rc view -layer M5 -capacitance 1.3323e-01 -resistance 1.4677e-02
	set_layer_rc view -layer M6 -capacitance 1.1575e-01 -resistance 1.0371e-02
	set_layer_rc view -layer M7 -capacitance 1.3293e-01 -resistance 9.6720e-03
	set_layer_rc view -layer M8 -capacitance 1.1822e-01 -resistance 7.4310e-03
	set_layer_rc view -layer M9 -capacitance 1.3497e-01 -resistance 6.8740e-03

	set_layer_rc view -via V1 -resistance 1.72E-02
	set_layer_rc view -via V2 -resistance 1.72E-02
	set_layer_rc view -via V3 -resistance 1.72E-02
	set_layer_rc view -via V4 -resistance 1.18E-02
	set_layer_rc view -via V5 -resistance 1.18E-02
	set_layer_rc view -via V6 -resistance 8.20E-03
	set_layer_rc view -via V7 -resistance 8.20E-03
	set_layer_rc view -via V8 -resistance 6.30E-03
}

if {$pdk_name eq "sky130"} {
	set_layer_rc view -layer li1 -capacitance 2.582652E-4 -resistance 1.E-1
	set_layer_rc view -via mcon -resistance 2.3E-2
	set_layer_rc view -layer met1 -capacitance 2.246984E-4 -resistance 1.035714E-3
	set_layer_rc view -via via -resistance 3.E-2
	set_layer_rc view -layer met2 -capacitance 1.384201E-4 -resistance 1.035714E-3
	set_layer_rc view -via via2 -resistance 8.E-3
	set_layer_rc view -layer met3 -capacitance 7.435933E-5 -resistance 1.866667E-4
	set_layer_rc view -via via3 -resistance 8.E-3
	set_layer_rc view -layer met4 -capacitance 6.030297E-5 -resistance 1.866667E-4
	set_layer_rc view -via via4 -resistance 8.91E-4
